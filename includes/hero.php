...
<div class="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 py-24 sm:py-32" style="background: var(--bg-main);">
    ...
    <div class="absolute inset-0 z-0">
        <div class="absolute inset-0 bg-[radial-gradient(circle_farthest-side_at_var(--x,_50%)_var(--y,_50%),_rgba(20,184,166,0.05)_0%,_transparent_100%)]"></div>
        <div class="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]"></div>
        <div class="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-teal-500/5 blur-[120px] animate-pulse"></div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-blue-600/5 blur-[120px] animate-pulse-slow"></div>
    </div>
