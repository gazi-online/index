...
?>
<section class="relative overflow-hidden pt-32 pb-24 md:pt-48 md:pb-36" style="background: var(--bg-main);">
    <!-- Modern Tailwind Animated Background -->
    <div class="modern-bg">
        <div class="modern-bg-blob modern-bg-teal"></div>
        <div class="modern-bg-blob modern-bg-blue"></div>
    </div>
