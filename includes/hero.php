...
?>
<div class="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 py-24 sm:py-32">
    ...
    <div class="relative z-10 max-w-5xl w-full text-center space-y-8">
        ...
        <div class="reveal reveal-up space-y-4">
            <h1 class="text-5xl sm:text-7xl lg:text-8xl font-black tracking-tight text-white leading-[1.1]">
            ...
            <a href="tel:6295051584" class="inline-flex items-center gap-3 text-2xl sm:text-3xl font-extrabold text-amber-400 hover:text-amber-300 transition-colors">
        ...
        <div class="reveal reveal-up grid grid-cols-1 md:grid-cols-3 gap-4 py-8">
            <!-- How to Book -->
            <div class="glass p-6 rounded-3xl text-left border-teal-500/20 group hover:border-teal-500/40 transition-all">
                <div class="w-12 h-12 rounded-2xl bg-teal-500/10 flex items-center justify-center mb-4 text-teal-400">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg>
                </div>
                <h3 class="text-white font-bold mb-2">How to Book</h3>
                <p class="text-slate-400 text-sm">Click 'Book' button, fill details, and confirm your slot instantly.</p>
            </div>

            <!-- How to get OTP -->
            <div class="glass p-6 rounded-3xl text-left border-amber-500/20 group hover:border-amber-500/40 transition-all">
                <div class="w-12 h-12 rounded-2xl bg-amber-500/10 flex items-center justify-center mb-4 text-amber-400">
                ...
                <h3 class="text-white font-bold mb-2">How to get OTP</h3>
                <p class="text-slate-400 text-sm">Check your WhatsApp after booking. We send OTP for secure tracking.</p>
            </div>

            <!-- Track Status Button Inside Grid -->
            <div onclick="toggleTrackModal(true)" class="glass p-6 rounded-3xl text-left border-blue-500/20 group hover:border-blue-500/40 transition-all cursor-pointer bg-blue-500/5">
                <div class="w-12 h-12 rounded-2xl bg-blue-500/10 flex items-center justify-center mb-4 text-blue-400">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                </div>
                <h3 class="text-white font-bold mb-2">📍 Track Status</h3>
                <p class="text-slate-400 text-sm">Real-time update on your application. Click here to check now.</p>
            </div>
        </div>
        ...
        <div class="reveal reveal-up flex flex-wrap items-center justify-center gap-4">
            ...
            <div class="flex items-center gap-4">
                ...
                <button onclick="toggleTrackModal(true)" class="btn-secondary px-8 py-5 rounded-2xl flex items-center gap-3 border-blue-500/20 hover:border-blue-500/40 transition-all font-bold text-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-blue-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m12 16 4-4-4-4"/><path d="M8 12h8"/></svg>
                    Track Status
                </button>
            </div>
        </div>
    ...
    <!-- Scroll Indicator -->
    <button onclick="scrollToSection('services')" class="reveal reveal-fade absolute bottom-10 left-1/2 -translate-x-1/2 text-slate-500 animate-bounce">
